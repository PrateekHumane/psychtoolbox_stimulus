classdef CheckerFlickerStimulus < handle
   ...
   methods (Access = public)
      ...
      function createMovie(obj, movieProperties)
          ...
          %Screen('AddFrameToMovie', obj.tex(1),[movieProperties.width,movieProperties.height],'frontBuffer',moviePtr,((movieProperties.frameRate/obj.flickerFrequency)/2)); % frames/second*second/switch
          %disp(floor((movieProperties.frameRate/obj.flickerFrequency)/2)+1);
          Screen('AddFrameToMovie', obj.tex(1),[],[],[],floor((movieProperties.frameRate/obj.flickerFrequency)/2)+1); % frames/second*second/switch
          Screen('AddFrameToMovie', obj.tex(2),[],[],[],floor((movieProperties.frameRate/obj.flickerFrequency)/2)+1); % frames/second*second/switch
